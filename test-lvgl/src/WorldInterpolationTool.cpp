    ...
    uint32_t newHeight)
{
    ...
    spdlog::debug(
        "Interpolating CellB grid: {}x{} -> {}x{}, scale factors: {:.3f}x{:.3f}",
        oldWidth,
        oldHeight,
        newWidth,
        newHeight,
...
CellB WorldInterpolationTool::createInterpolatedCellB(
    const CellB& cell00,
    const CellB& cell10,
    const CellB& cell01,
    const CellB& cell11,
    ...
    double fy)
{
    ...
    result.water =
        bilinearInterpolateDouble(cell00.water, cell10.water, cell01.water, cell11.water, fx, fy);
    result.wood =
        bilinearInterpolateDouble(cell00.wood, cell10.wood, cell01.wood, cell11.wood, fx, fy);
    result.leaf =
        bilinearInterpolateDouble(cell00.leaf, cell10.leaf, cell01.leaf, cell11.leaf, fx, fy);
    result.metal =
        bilinearInterpolateDouble(cell00.metal, cell10.metal, cell01.metal, cell11.metal, fx, fy);
