...
public:
     ...
     */
    static void onAssertionFailure(const char* condition, const char* file, int line, const char* message);
...
private:
    ...
    static void writeWorldStateToFile(const std::string& filename, const char* reason, 
                                    const char* condition = nullptr, const char* file = nullptr, 
                                    int line = 0, const char* message = nullptr);
