...
private:
     ...
     */
    static double bilinearInterpolateDouble(double val00, double val10, double val01, double val11, 
                                          double fx, double fy);
    
    /**
     * @brief Bilinear interpolation for Vector2d values
     */
    static Vector2d bilinearInterpolateVector2d(const Vector2d& val00, const Vector2d& val10, 
     ...
     */
    static MaterialType interpolateMaterialType(const CellB& cell00, const CellB& cell10,
     ...
     */
    static CellB createInterpolatedCellB(const CellB& cell00, const CellB& cell10,
                                        const CellB& cell01, const CellB& cell11,
                                        double fx, double fy);
    ...
    static bool sampleNeighboringCells(const WorldInterface& world, 
                                     double srcX, double srcY,
                                     CellType& cell00, CellType& cell10,
                                     CellType& cell01, CellType& cell11,
                                     double& fx, double& fy);
